...
//         s_secrets[tempStackVariables.startTime] = new bytes32[](tempStackVariables.operatorsLength);
...
//         bytes32[] storage s_ssArray = s_secrets[tempStackVariables.startTime];
...
//         bytes32[] storage s_ssArray = s_secrets[startTime];
