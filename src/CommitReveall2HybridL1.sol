...
contract CommitReveal2L1 is Ownable, EIP712, CommitReveal2StorageHybridL1 {
    constructor(
    ...
    function requestRandomNumber(
        ...
        uint256 activatedOperatorsLength = s_activatedOperators.length - 1;
        ...
        address[] memory activatedOperatorsAtRound;
        s_activatedOperatorsAtRound[
            round
        ] = activatedOperatorsAtRound = s_activatedOperators;
        ...
        uint256 i = 1;
        do {
            activatedOperatorOrderAtRound[activatedOperatorsAtRound[i]] = i;
            unchecked {
                ++i;
            }
        } while (i <= activatedOperatorsLength);
        //emit RandomNumberRequested(round, activatedOperatorsAtRound);
    }

    // *** For Operators
    function submitMerkleRoot(uint256 round, bytes32 merkleRoot) external {
        require(
    ...
    function generateRandomNumber(
        ...
        //emit RandomNumberGenerated(round, randomNumber, callbackSuccess);
    }
