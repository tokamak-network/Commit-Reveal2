...
//                 mstore(0x20, and(calldataload(sub(0x24, shr(5, i))), 0xff)) // v, 0x24: vsOffset
...
//                         and(calldataload(sub(0x84, activatedOperatorsLength)), 0xff) // last revealer index, 0x84: revealOrdersOffset
//                     )
//                 )
